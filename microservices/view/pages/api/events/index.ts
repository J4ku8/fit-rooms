...
const handler = async (_req: NextApiRequest, res: NextApiResponse) => {
    try {
        ...
        // const eventsMessega = await client?.api(`/users/${roomEmail}/events?startDateTime=${date}T00:00:00&endDateTime=${date}T23:59:59`)
        //     .header('Prefer','outlook.timezone="Central Europe Standard Time"')
        //     .select("subject,body,bodyPreview,organizer,start,end")
        //     .orderby('start/dateTime')
        //     .get()
        // console.log("eventsMessega", eventsMessega)
